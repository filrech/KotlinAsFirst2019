...
fun russian(n: Int): String {
    ...
    if (number > 1000) {
        ...
        if (number % 100 in 11..19) {
            ...
            result += l3[number / 100]
            result += l2thd[number / 10 % 10]
            if (number % 10 == 0) result += "тысяч "
            if (number % 10 == 1) result += l4[number % 10] + "тысяча "
            if (number % 10 in 2..4) result += l4[number % 10] + "тысячи "
            if (number % 10 in 5..9) result += l4[number % 10] + "тысяч "
        }
        number = n % 1000
    }
    if (number < 1000) {
