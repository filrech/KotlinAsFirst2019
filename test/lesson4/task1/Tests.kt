...
class Tests {
    ...
    fun russian() {
        ...
        assertEquals("сто двадцать семь тысяч четыресто пятьдесят шесть", russian(127456))
        assertEquals("семьсот тридцать шесть тысяч четыресто тридцать два", russian(736432))
